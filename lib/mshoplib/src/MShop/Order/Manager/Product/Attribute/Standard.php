...
/**
 * Default order manager product attribute.
 *
 * @package MShop
 * @subpackage Order
 */
	...
	implements \Aimeos\MShop\Order\Manager\Product\Attribute\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	{
		/** mshop/order/manager/product/attribute/standard/aggregate/mysql
		 * Counts the number of records grouped by the values in the key column and matched by the given criteria
		 *
		 * @see mshop/order/manager/product/attribute/standard/aggregate/ansi
		 */

		/** mshop/order/manager/product/attribute/standard/aggregate/ansi
		 * Counts the number of records grouped by the values in the key column and matched by the given criteria
		 *
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/product/attribute/standard/insert/ansi
		 * @see mshop/order/manager/product/attribute/standard/update/ansi
		 * @see mshop/order/manager/product/attribute/standard/newid/ansi
		 * @see mshop/order/manager/product/attribute/standard/delete/ansi
		 * @see mshop/order/manager/product/attribute/standard/search/ansi
		 * @see mshop/order/manager/product/attribute/standard/count/ansi
		 */
		$cfgkey = 'mshop/order/manager/product/attribute/standard/aggregate' . $type;
		return $this->aggregateBase( $search, $key, $cfgkey, array( 'order.product.attribute' ), $value );
	}
	...
	public function clear( array $siteids )
	{
		...
		return $this->clearBase( $siteids, 'mshop/order/manager/product/attribute/standard/delete' );
	}
	...
	{
		$values['order.product.attribute.siteid'] = $this->getContext()->getLocale()->getSiteId();
	 ...
	 * @return \Aimeos\MShop\Order\Item\Product\Attribute\Iface Returns order product attribute item of the given id
	...
	{
		/** mshop/order/manager/product/attribute/standard/delete/mysql
		 * Deletes the items matched by the given IDs from the database
		 *
		 * @see mshop/order/manager/product/attribute/standard/delete/ansi
		 */

		/** mshop/order/manager/product/attribute/standard/delete/ansi
		 * Deletes the items matched by the given IDs from the database
		 *
		 ...
		 * @see mshop/order/manager/product/attribute/standard/count/ansi
		 */
		$path = 'mshop/order/manager/product/attribute/standard/delete';
	...
	public function getSearchAttributes( $withsub = true )
	{
		 ...
		 * List of manager names that can be instantiated by the order product attribute manager
		 *
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 * Class name of the used order product attribute manager implementation
		 *
		 * Each default order product attribute manager can be replaced by an alternative imlementation.
		 ...
		 * Excludes decorators added by the "common" option from the order product attribute manager
		 *
		 ...
		 * around the order product attribute manager.
		 *
		 *  mshop/order/manager/product/attribute/decorators/excludes = array( 'decorator1' )
		 *
		 * This would remove the decorator named "decorator1" from the list of
		 * common decorators ("\Aimeos\MShop\Common\Manager\Decorator\*") added via
		 * "mshop/common/manager/decorators/default" for the order product attribute manager.
		 *
		 ...
		 * Adds a list of globally available decorators only to the order product attribute manager
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * Adds a list of local decorators only to the order product attribute manager
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * only to the order product attribute manager.
		 *
		 * @param array List of decorator names
		 * @since 2014.03
		 * @category Developer
	 ...
	 */
	public function saveItem( \Aimeos\MShop\Order\Item\Product\Attribute\Iface $item, $fetch = true )
	{
		if( !$item->isModified() ) {
			return $item;
		}
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/product/attribute/standard/insert/mysql
				 * Inserts a new order record into the database table
				 *
				 * @see mshop/order/manager/product/attribute/standard/insert/ansi
				 */

				/** mshop/order/manager/product/attribute/standard/insert/ansi
				 * Inserts a new order record into the database table
				 *
				 ...
				 * @see mshop/order/manager/product/attribute/standard/count/ansi
				 */
				$path = 'mshop/order/manager/product/attribute/standard/insert';
				$sql = $this->addSqlColumns( array_keys( $columns ), $this->getSqlConfig( $path ) );
			}
			else
			{
				/** mshop/order/manager/product/attribute/standard/update/mysql
				 * Updates an existing order record in the database
				 *
				 * @see mshop/order/manager/product/attribute/standard/update/ansi
				 */

				/** mshop/order/manager/product/attribute/standard/update/ansi
				 * Updates an existing order record in the database
				 *
				 ...
				 * @see mshop/order/manager/product/attribute/standard/count/ansi
				 */
				$path = 'mshop/order/manager/product/attribute/standard/update';
			...
			{
				/** mshop/order/manager/product/attribute/standard/newid/mysql
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 * @see mshop/order/manager/product/attribute/standard/newid/ansi
				 */

				/** mshop/order/manager/product/attribute/standard/newid/ansi
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 ...
				 * @see mshop/order/manager/product/attribute/standard/count/ansi
				 */
				$path = 'mshop/order/manager/product/attribute/standard/newid';
	 ...
	 * @return \Aimeos\MShop\Order\Item\Product\Attribute\Iface[] List of order product attribute items
	 */
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = [], &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/product/attribute/standard/search/mysql
			 * Retrieves the records matched by the given criteria in the database
			 *
			 * @see mshop/order/manager/product/attribute/standard/search/ansi
			 */

			/** mshop/order/manager/product/attribute/standard/search/ansi
			 * Retrieves the records matched by the given criteria in the database
			 *
			 ...
			 * @see mshop/order/manager/product/attribute/standard/count/ansi
			 */
			$cfgPathSearch = 'mshop/order/manager/product/attribute/standard/search';

			/** mshop/order/manager/product/attribute/standard/count/mysql
			 * Counts the number of records matched by the given criteria in the database
			 *
			 * @see mshop/order/manager/product/attribute/standard/count/ansi
			 */

			/** mshop/order/manager/product/attribute/standard/count/ansi
			 * Counts the number of records matched by the given criteria in the database
			 *
			 ...
			 * @see mshop/order/manager/product/attribute/standard/search/ansi
			 */
			$cfgPathCount = 'mshop/order/manager/product/attribute/standard/count';
			...
			try
			{
				...
				{
					if( ( $row['order.product.attribute.value'] = json_decode( $config = $row['order.product.attribute.value'], true ) ) === null )
					{
						$msg = sprintf( 'Invalid JSON as result of search for ID "%2$s" in "%1$s": %3$s', 'mshop_order_product_attribute.value', $row['order.product.attribute.id'], $config );
						$this->getContext()->getLogger()->log( $msg, \Aimeos\MW\Logger\Base::WARN );
					}
					$items[(string) $row['order.product.attribute.id']] = $this->createItemBase( $row );
				}
			}
			catch( \Exception $e )
			{
	...
	/**
	 * Creates new order product attribute item object initialized with given parameters.
	 *
