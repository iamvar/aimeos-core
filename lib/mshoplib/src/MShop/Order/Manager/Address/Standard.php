	...
	implements \Aimeos\MShop\Order\Manager\Address\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		'order.address.id' => array(
			...
			'internaldeps' => array( 'LEFT JOIN "mshop_order_address" AS  mordad ON (  mord."id" =  mordad."orderid" )' ),
			'label' => 'Address ID',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
			'public' => false,
		),
		'order.address.orderid' => array(
			'code' => 'order.address.orderid',
			'internalcode' => ' mordad."orderid"',
			'label' => 'Order ID',
			'type' => 'integer',
			'internaltype' => \Aimeos\MW\DB\Statement\Base::PARAM_INT,
			'public' => false,
	...
	{
		/** mshop/order/manager/address/standard/aggregate/mysql
		 * Counts the number of records grouped by the values in the key column and matched by the given criteria
		 *
		 * @see mshop/order/manager/address/standard/aggregate/ansi
		 */

		/** mshop/order/manager/address/standard/aggregate/ansi
		 * Counts the number of records grouped by the values in the key column and matched by the given criteria
		 *
		 ...
		 * @since 2014.09
		 * @category Developer
		 * @see mshop/order/manager/address/standard/insert/ansi
		 * @see mshop/order/manager/address/standard/update/ansi
		 * @see mshop/order/manager/address/standard/newid/ansi
		 * @see mshop/order/manager/address/standard/delete/ansi
		 * @see mshop/order/manager/address/standard/search/ansi
		 * @see mshop/order/manager/address/standard/count/ansi
		 */
		$cfgkey = 'mshop/order/manager/address/standard/aggregate' . $type;
		return $this->aggregateBase( $search, $key, $cfgkey, array( 'order.address' ), $value );
	}
	...
	public function clear( array $siteids )
	{
		...
		return $this->clearBase( $siteids, 'mshop/order/manager/address/standard/delete' );
	}
	...
	{
		$values['order.address.siteid'] = $this->getContext()->getLocale()->getSiteId();
	...
	{
		/** mshop/order/manager/address/standard/delete/mysql
		 * Deletes the items matched by the given IDs from the database
		 *
		 * @see mshop/order/manager/address/standard/delete/ansi
		 */

		/** mshop/order/manager/address/standard/delete/ansi
		 * Deletes the items matched by the given IDs from the database
		 *
		 ...
		 * @see mshop/order/manager/address/standard/count/ansi
		 */
		$path = 'mshop/order/manager/address/standard/delete';
	...
	/**
	 * Creates a order address item object for the given item id.
	 *
	 * @param string $id Id of the order address item
	 * @param string[] $ref List of domains to fetch list items and referenced items for
	 * @param boolean $default Add default criteria
	 * @return \Aimeos\MShop\Order\Item\Address\Iface Returns order address item of the given id
	...
	public function getSearchAttributes( $withsub = true )
	{
		 ...
		 * List of manager names that can be instantiated by the order address manager
		 *
	...
	public function getSubManager( $manager, $name = null )
	{
		 ...
		 * Class name of the used order address manager implementation
		 *
		 * Each default order address manager can be replaced by an alternative imlementation.
		 ...
		 * Excludes decorators added by the "common" option from the order address manager
		 *
		 ...
		 * around the order address manager.
		 *
		 *  mshop/order/manager/address/decorators/excludes = array( 'decorator1' )
		 *
		 * This would remove the decorator named "decorator1" from the list of
		 * common decorators ("\Aimeos\MShop\Common\Manager\Decorator\*") added via
		 * "mshop/common/manager/decorators/default" for the order address manager.
		 *
		 ...
		 * Adds a list of globally available decorators only to the order address manager
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
		 ...
		 * Adds a list of local decorators only to the order address manager
		 *
		 * Decorators extend the functionality of a class by adding new aspects
		 * (e.g. log what is currently done), executing the methods of the underlying
		 * class only in certain conditions (e.g. only for logged in users) or
	...
	/**
	 * Inserts the new order address items
	 *
	 ...
	 */
	public function saveItem( \Aimeos\MShop\Order\Item\Address\Iface $item, $fetch = true )
	{
		if( !$item->isModified() ) {
			return $item;
		}
		...
		try
		{
			...
			if( $id === null )
			{
				/** mshop/order/manager/address/standard/insert/mysql
				 * Inserts a new order record into the database table
				 *
				 * @see mshop/order/manager/address/standard/insert/ansi
				 */

				/** mshop/order/manager/address/standard/insert/ansi
				 * Inserts a new order record into the database table
				 *
				 ...
				 * @see mshop/order/manager/address/standard/count/ansi
				 */
				$path = 'mshop/order/manager/address/standard/insert';
				$sql = $this->addSqlColumns( array_keys( $columns ), $this->getSqlConfig( $path ) );
			}
			else
			{
				/** mshop/order/manager/address/standard/update/mysql
				 * Updates an existing order record in the database
				 *
				 * @see mshop/order/manager/address/standard/update/ansi
				 */

				/** mshop/order/manager/address/standard/update/ansi
				 * Updates an existing order record in the database
				 *
				 ...
				 * @see mshop/order/manager/address/standard/count/ansi
				 */
				$path = 'mshop/order/manager/address/standard/update';
			...
			{
				/** mshop/order/manager/address/standard/newid/mysql
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 * @see mshop/order/manager/address/standard/newid/ansi
				 */

				/** mshop/order/manager/address/standard/newid/ansi
				 * Retrieves the ID generated by the database when inserting a new record
				 *
				 ...
				 * @see mshop/order/manager/address/standard/count/ansi
				 */
				$path = 'mshop/order/manager/address/standard/newid';
	...
	/**
	 * Search for order address items based on the given critera.
	 *
	...
	public function searchItems( \Aimeos\MW\Criteria\Iface $search, array $ref = [], &$total = null )
	{
		...
		try
		{
			...
			/** mshop/order/manager/address/standard/search/mysql
			 * Retrieves the records matched by the given criteria in the database
			 *
			 * @see mshop/order/manager/address/standard/search/ansi
			 */

			/** mshop/order/manager/address/standard/search/ansi
			 * Retrieves the records matched by the given criteria in the database
			 *
			 ...
			 * @see mshop/order/manager/address/standard/count/ansi
			 */
			$cfgPathSearch = 'mshop/order/manager/address/standard/search';

			/** mshop/order/manager/address/standard/count/mysql
			 * Counts the number of records matched by the given criteria in the database
			 *
			 * @see mshop/order/manager/address/standard/count/ansi
			 */

			/** mshop/order/manager/address/standard/count/ansi
			 * Counts the number of records matched by the given criteria in the database
			 *
			 ...
			 * @see mshop/order/manager/address/standard/search/ansi
			 */
			$cfgPathCount = 'mshop/order/manager/address/standard/count';
			...
			try
			{
				while( ( $row = $results->fetch() ) !== false ) {
					$items[(string) $row['order.address.id']] = $this->createItemBase( $row );
				}
			}
			catch( \Exception $e )
			{
	...
	/**
	 * Creates new order address item object.
	 *
