...
/**
 * Interface for order item service.
 *
 * @package MShop
 * @subpackage Order
 */
	...
	extends \Aimeos\MShop\Common\Item\Iface, \Aimeos\MShop\Common\Item\Position\Iface, \Aimeos\MShop\Common\Item\TypeRef\Iface
{
	 ...
	 *
	 * @param string $id Order service order ID
	 * @return \Aimeos\MShop\Order\Item\Service\Iface Order service item for chaining method calls
	 */
	 ...
	 * @param string $code Code of the product attribute item
	 * @param array|string $type Type or list of types of the product attribute items
	 * @return \Aimeos\MShop\Order\Item\Product\Attribute\Iface|null Attribute item for the ordered product and the given code
	 */
	 ...
	 * @return array List of attribute items implementing \Aimeos\MShop\Order\Item\Service\Attribute\Iface
	 */
	 ...
	 * @return \Aimeos\MShop\Order\Item\Service\Iface Order service item for chaining method calls
	 */
	public function setAttributeItem( \Aimeos\MShop\Order\Item\Service\Attribute\Iface $item );
