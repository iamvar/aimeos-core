...
interface Iface extends \Aimeos\MW\Observer\Publisher\Iface, \Aimeos\MShop\Common\Item\Iface
{
	 ...
	 * @return bool
	 */
	public function check( $what = \Aimeos\MShop\Order\Item\Base::PARTS_ALL );
	 ...
	 *
	 * @return array Array of \Aimeos\MShop\Order\Item\Address\Iface order address items
	 */
	 ...
	 *
	 * @return array Associative array of codes and lists of product items implementing \Aimeos\MShop\Order\Item\Product\Iface
	 */
	 ...
	 *
	 * @return array Array of \Aimeos\MShop\Order\Item\Service\Iface Order service items
	 */
