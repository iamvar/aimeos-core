...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testAggregate()
	{
		...
		$search->setConditions( $search->compare( '==', 'order.product.attribute.editor', 'core:lib/mshoplib' ) );
		$result = $this->object->aggregate( $search, 'order.product.attribute.code' );
	...
	public function testSearchItems()
	{
		...
		$expr[] = $search->compare( '!=', 'order.product.attribute.type', '' );
	...
	public function testSaveUpdateDeleteItem()
	{
		$search = $this->object->createSearch();
		$conditions = array(
			$search->compare( '==', 'order.product.attribute.value', 33 ),
			$search->compare( '==', 'order.product.attribute.editor', $this->editor )
		);
		$search->setConditions( $search->combine( '&&', $conditions ) );
