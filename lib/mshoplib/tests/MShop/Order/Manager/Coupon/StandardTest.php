...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testAggregate()
	{
		...
		$search->setConditions( $search->compare( '==', 'order.coupon.editor', 'core:lib/mshoplib' ) );
		$result = $this->object->aggregate( $search, 'order.coupon.code' );
	...
	{
		$this->assertInstanceOf( \Aimeos\MShop\Order\Item\Coupon\Iface::class, $this->object->createItem() );
	}
