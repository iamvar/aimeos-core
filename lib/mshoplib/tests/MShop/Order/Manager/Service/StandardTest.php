...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testAggregate()
	{
		...
		$search->setConditions( $search->compare( '==', 'order.service.editor', 'core:lib/mshoplib' ) );
		$result = $this->object->aggregate( $search, 'order.service.code' );
	...
	public function testAggregateAvg()
	{
		$search = $this->object->createSearch();
		$search->setConditions( $search->compare( '==', 'order.service.editor', 'core:lib/mshoplib' ) );
		$result = $this->object->aggregate( $search, 'order.service.type', 'order.service.costs', 'avg' );
	...
	public function testAggregateSum()
	{
		$search = $this->object->createSearch();
		$search->setConditions( $search->compare( '==', 'order.service.editor', 'core:lib/mshoplib' ) );
		$result = $this->object->aggregate( $search, 'order.service.type', 'order.service.costs', 'sum' );
	...
	public function testSearchItems()
	{
		...
		$expr[] = $search->compare( '==', 'order.service.tax', '0.00' );
		...
		$search = $this->object->createSearch();
		$conditions = array(
			$search->compare( '==', 'order.service.code', array( 'OGONE', 'not exists' ) ),
	...
	public function testGetItem()
	{
		...
		$conditions = array(
			$search->compare( '==', 'order.service.code', 'OGONE' ),
			$search->compare( '==', 'order.service.editor', $this->editor ),
		);
		$search->setConditions( $search->combine( '&&', $conditions ) );
