...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	{
		$return = $this->object->setOrderId( 33 );

		$this->assertInstanceOf( \Aimeos\MShop\Order\Item\Address\Iface::class, $return );
		$this->assertEquals( 33, $this->object->getOrderId() );
		$this->assertTrue( $this->object->isModified() );
	}
	...
	public function testFromArray()
	{
		...
		$this->assertEquals( $list['order.address.orderid'], $object->getOrderId() );
	...
	public function testToArray()
	{
		...
		$this->assertEquals( $this->object->getEditor(), $arrayObject['order.address.editor'] );
	}
