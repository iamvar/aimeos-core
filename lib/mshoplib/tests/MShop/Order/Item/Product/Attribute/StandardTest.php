...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	public function testFromArray()
	{
		...
		$list = $entries = array(
			...
			'order.product.attribute.attrid' => 2,
		...
		$this->assertEquals( $list['order.product.attribute.attrid'], $item->getAttributeId() );
	...
	public function testToArray()
	{
		...
		$this->assertEquals( $this->object->getAttributeId(), $list['order.product.attribute.attrid'] );
		...
		$this->assertEquals( $this->object->getEditor(), $list['order.product.attribute.editor'] );
	}
