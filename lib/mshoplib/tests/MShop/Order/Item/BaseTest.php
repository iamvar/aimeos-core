...
class BaseTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp()
	{
		...
		$this->object = new \Aimeos\MShop\Order\Item\Standard( $priceManager->createItem(), $locale, [] );
	...
	public function testCheck()
	{
		...
		$this->object->check( \Aimeos\MShop\Order\Item\Base::PARTS_ALL );
	}
	...
	{
		$this->setExpectedException( \Aimeos\MShop\Order\Exception::class );
		$this->object->check( \Aimeos\MShop\Order\Item\Base::PARTS_PRODUCT );
	}
