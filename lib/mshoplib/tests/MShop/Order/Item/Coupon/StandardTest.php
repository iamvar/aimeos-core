...
class StandardTest extends \PHPUnit\Framework\TestCase
{
	...
	{
		$return = $this->object->setOrderId( 99 );

		$this->assertInstanceOf( \Aimeos\MShop\Order\Item\Coupon\Iface::class, $return );
		$this->assertEquals( 99, $this->object->getOrderId() );
		$this->assertTrue( $this->object->isModified() );
	}
	...
	public function testFromArray()
	{
		...
		$this->assertEquals( $list['order.coupon.orderid'], $item->getOrderId() );
	...
	public function testToArray()
	{
		...
		$this->assertEquals( $this->object->getOrderId(), $array['order.coupon.orderid'] );
		...
		$this->assertEquals( $this->object->getEditor(), $array['order.coupon.editor'] );
	}
