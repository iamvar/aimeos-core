	...
	'manager' => array(
		'currency' => array(
			...
			'search' => array(
				'ansi' => '
					...
					FROM "mshop_locale_currencyloccu
					WHERE :cond
					ORDER BY :order
		...
		'language' => array(
			...
			'search' => array(
				'ansi' => '
					...
					FROM "mshop_locale_languagelocla
					WHERE :cond
					ORDER BY :order
					OFFSET :start ROWS FETCH NEXT :size ROWS ONLY
				',
		...
		'search' => array(
			'ansi' => '
				...
				FROM "mshop_localeloc
				LEFT JOIN "mshop_locale_sitelocsi ON (mloc."siteid" = mlocsi."siteid")
				LEFT JOIN "mshop_locale_languagelocla ON (mloc."langid" = mlocla."id")
				LEFT JOIN "mshop_locale_currencyloccu ON (mloc."currencyid" = mloccu."id")
				WHERE :cond
