				...
				'aggregate' => array(
					'ansi' => '
						...
						FROM (
							...
							FROM "mshop_order_base_addressordbaad
							:joins
							WHERE :cond
			...
			'coupon' => array(
				'aggregate' => array(
					'ansi' => '
						...
						FROM (
							SELECT :acols, :val AS "val"
							FROM "mshop_order_base_couponordbaco
							:joins
							WHERE :cond
			...
			'product' => array(
				'attribute' => array(
					'aggregate' => array(
						'ansi' => '
							...
							FROM (
								SELECT :acols, :val AS "val"
								FROM "mshop_order_base_product_attrordbaprat
								:joins
								WHERE :cond
				...
				'aggregate' => array(
					'ansi' => '
						...
						FROM (
							SELECT :acols, :val AS "val"
							FROM "mshop_order_base_productordbapr
							:joins
							WHERE :cond
			...
			'service' => array(
				'attribute' => array(
					'aggregate' => array(
						'ansi' => '
							...
							FROM (
								SELECT :acols, :val AS "val"
								FROM "mshop_order_base_service_attrordbaseat
								:joins
								WHERE :cond
				...
				'aggregate' => array(
					'ansi' => '
						...
						FROM (
							SELECT :acols, :val AS "val"
							FROM "mshop_order_base_serviceordbase
							:joins
							WHERE :cond
